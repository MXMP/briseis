...
FWVer = {
    # FW    .1.3.6.1.4.1.6339.100.1.3.0   sysSoftwareVersion
    'FW.': '.1.3.6.1.4.1.6339.100.1.3.0'
}
...
DuplexStatus = {
    # DS     .1.3.6.1.4.1.6339.100.3.2.1.12   speedDuplex
    'DS.1': '.1.3.6.1.4.1.6339.100.3.2.1.12.1',
    'DS.2': '.1.3.6.1.4.1.6339.100.3.2.1.12.2',
    'DS.3': '.1.3.6.1.4.1.6339.100.3.2.1.12.3',
    'DS.4': '.1.3.6.1.4.1.6339.100.3.2.1.12.4',
    'DS.5': '.1.3.6.1.4.1.6339.100.3.2.1.12.5',
    'DS.6': '.1.3.6.1.4.1.6339.100.3.2.1.12.6',
    'DS.7': '.1.3.6.1.4.1.6339.100.3.2.1.12.7',
    'DS.8': '.1.3.6.1.4.1.6339.100.3.2.1.12.8',
    'DS.9': '.1.3.6.1.4.1.6339.100.3.2.1.12.9',
    'DS.10': '.1.3.6.1.4.1.6339.100.3.2.1.12.10',
    'DS.11': '.1.3.6.1.4.1.6339.100.3.2.1.12.11',
    'DS.12': '.1.3.6.1.4.1.6339.100.3.2.1.12.12',
    'DS.13': '.1.3.6.1.4.1.6339.100.3.2.1.12.13',
    'DS.14': '.1.3.6.1.4.1.6339.100.3.2.1.12.14',
    'DS.15': '.1.3.6.1.4.1.6339.100.3.2.1.12.15',
    'DS.16': '.1.3.6.1.4.1.6339.100.3.2.1.12.16',
    'DS.17': '.1.3.6.1.4.1.6339.100.3.2.1.12.17',
    'DS.18': '.1.3.6.1.4.1.6339.100.3.2.1.12.18',
    'DS.19': '.1.3.6.1.4.1.6339.100.3.2.1.12.19',
    'DS.20': '.1.3.6.1.4.1.6339.100.3.2.1.12.20',
    'DS.21': '.1.3.6.1.4.1.6339.100.3.2.1.12.21',
    'DS.22': '.1.3.6.1.4.1.6339.100.3.2.1.12.22',
    'DS.23': '.1.3.6.1.4.1.6339.100.3.2.1.12.23',
    'DS.24': '.1.3.6.1.4.1.6339.100.3.2.1.12.24',
    'DS.25': '.1.3.6.1.4.1.6339.100.3.2.1.12.25',
    'DS.26': '.1.3.6.1.4.1.6339.100.3.2.1.12.26',
    'DS.27': '.1.3.6.1.4.1.6339.100.3.2.1.12.27',
    'DS.28': '.1.3.6.1.4.1.6339.100.3.2.1.12.28',
}

PORTutil = {
    # PORTutil     .1.3.6.1.4.1.6339.100.3.2.1.23   portBandWidthUsage
    'PORTutil.1': '.1.3.6.1.4.1.6339.100.3.2.1.23.1',
    'PORTutil.2': '.1.3.6.1.4.1.6339.100.3.2.1.23.2',
    'PORTutil.3': '.1.3.6.1.4.1.6339.100.3.2.1.23.3',
    'PORTutil.4': '.1.3.6.1.4.1.6339.100.3.2.1.23.4',
    'PORTutil.5': '.1.3.6.1.4.1.6339.100.3.2.1.23.5',
    'PORTutil.6': '.1.3.6.1.4.1.6339.100.3.2.1.23.6',
    'PORTutil.7': '.1.3.6.1.4.1.6339.100.3.2.1.23.7',
    'PORTutil.8': '.1.3.6.1.4.1.6339.100.3.2.1.23.8',
    'PORTutil.9': '.1.3.6.1.4.1.6339.100.3.2.1.23.9',
    'PORTutil.10': '.1.3.6.1.4.1.6339.100.3.2.1.23.10',
    'PORTutil.11': '.1.3.6.1.4.1.6339.100.3.2.1.23.11',
    'PORTutil.12': '.1.3.6.1.4.1.6339.100.3.2.1.23.12',
    'PORTutil.13': '.1.3.6.1.4.1.6339.100.3.2.1.23.13',
    'PORTutil.14': '.1.3.6.1.4.1.6339.100.3.2.1.23.14',
    'PORTutil.15': '.1.3.6.1.4.1.6339.100.3.2.1.23.15',
    'PORTutil.16': '.1.3.6.1.4.1.6339.100.3.2.1.23.16',
    'PORTutil.17': '.1.3.6.1.4.1.6339.100.3.2.1.23.17',
    'PORTutil.18': '.1.3.6.1.4.1.6339.100.3.2.1.23.18',
    'PORTutil.19': '.1.3.6.1.4.1.6339.100.3.2.1.23.19',
    'PORTutil.20': '.1.3.6.1.4.1.6339.100.3.2.1.23.20',
    'PORTutil.21': '.1.3.6.1.4.1.6339.100.3.2.1.23.21',
    'PORTutil.22': '.1.3.6.1.4.1.6339.100.3.2.1.23.22',
    'PORTutil.23': '.1.3.6.1.4.1.6339.100.3.2.1.23.23',
    'PORTutil.24': '.1.3.6.1.4.1.6339.100.3.2.1.23.24',
    'PORTutil.25': '.1.3.6.1.4.1.6339.100.3.2.1.23.25',
    'PORTutil.26': '.1.3.6.1.4.1.6339.100.3.2.1.23.26',
    'PORTutil.27': '.1.3.6.1.4.1.6339.100.3.2.1.23.27',
    'PORTutil.28': '.1.3.6.1.4.1.6339.100.3.2.1.23.28',
}

CPUutil = {
    # CPU    .1.3.6.1.4.1.6339.100.1.11.10    switchCpuUsage
    'CPU.': '.1.3.6.1.4.1.6339.100.1.11.10.0'
}

DRAMutil = {
    # DRAM    .1.3.6.1.4.1.6339.100.1.11.11    switchMemoryUsage
    'DRAM.': '.1.3.6.1.4.1.6339.100.1.11.11.0'
}

CNS = {
    # CNS      .1.3.6.1.4.1.6339.100.3.2.1.14    speedDuplex
    'CNS..1': '.1.3.6.1.4.1.6339.100.3.2.1.14.1',
    'CNS..2': '.1.3.6.1.4.1.6339.100.3.2.1.14.2',
    'CNS..3': '.1.3.6.1.4.1.6339.100.3.2.1.14.3',
    'CNS..4': '.1.3.6.1.4.1.6339.100.3.2.1.14.4',
    'CNS..5': '.1.3.6.1.4.1.6339.100.3.2.1.14.5',
    'CNS..6': '.1.3.6.1.4.1.6339.100.3.2.1.14.6',
    'CNS..7': '.1.3.6.1.4.1.6339.100.3.2.1.14.7',
    'CNS..8': '.1.3.6.1.4.1.6339.100.3.2.1.14.8',
    'CNS..9': '.1.3.6.1.4.1.6339.100.3.2.1.14.9',
    'CNS..10': '.1.3.6.1.4.1.6339.100.3.2.1.14.10',
    'CNS..11': '.1.3.6.1.4.1.6339.100.3.2.1.14.11',
    'CNS..12': '.1.3.6.1.4.1.6339.100.3.2.1.14.12',
    'CNS..13': '.1.3.6.1.4.1.6339.100.3.2.1.14.13',
    'CNS..14': '.1.3.6.1.4.1.6339.100.3.2.1.14.14',
    'CNS..15': '.1.3.6.1.4.1.6339.100.3.2.1.14.15',
    'CNS..16': '.1.3.6.1.4.1.6339.100.3.2.1.14.16',
    'CNS..17': '.1.3.6.1.4.1.6339.100.3.2.1.14.17',
    'CNS..18': '.1.3.6.1.4.1.6339.100.3.2.1.14.18',
    'CNS..19': '.1.3.6.1.4.1.6339.100.3.2.1.14.19',
    'CNS..20': '.1.3.6.1.4.1.6339.100.3.2.1.14.20',
    'CNS..21': '.1.3.6.1.4.1.6339.100.3.2.1.14.21',
    'CNS..22': '.1.3.6.1.4.1.6339.100.3.2.1.14.22',
    'CNS..23': '.1.3.6.1.4.1.6339.100.3.2.1.14.23',
    'CNS..24': '.1.3.6.1.4.1.6339.100.3.2.1.14.24',
    'CNS..25': '.1.3.6.1.4.1.6339.100.3.2.1.14.25',
    'CNS..26': '.1.3.6.1.4.1.6339.100.3.2.1.14.26',
    'CNS..27': '.1.3.6.1.4.1.6339.100.3.2.1.14.27',
    'CNS..28': '.1.3.6.1.4.1.6339.100.3.2.1.14.28',
}

CfgUpload = [
    # .1.3.6.1.4.1.6339.100.1.10.3  fileIPaddress
    ['.1.3.6.1.4.1.6339.100.1.10.3', '0', '10.200.201.180', 'IPADDR'],
    # .1.3.6.1.4.1.6339.100.1.10.4  sourceFileCopy
    ['.1.3.6.1.4.1.6339.100.1.10.4', '0', 'startup.cfg', 'OCTETSTR'],
    # .1.3.6.1.4.1.6339.100.1.10.5  destinationFileCopy
    ['.1.3.6.1.4.1.6339.100.1.10.5', '0', 'backup', 'OCTETSTR'],
    # .1.3.6.1.4.1.6339.100.1.10.7 fileCopyUseMode
    ['.1.3.6.1.4.1.6339.100.1.10.7', '0', '2', 'INTEGER'],
    # .1.3.6.1.4.1.6339.100.1.10.8 fileCopy
    ['.1.3.6.1.4.1.6339.100.1.10.8', '0', '1', 'INTEGER'],
]

CfgSave = [
    # .1.3.6.1.4.1.6339.100.1.6  sysWriteConfig
    ['.1.3.6.1.4.1.6339.100.1.6', '0', '1', 'INTEGER'],
]
